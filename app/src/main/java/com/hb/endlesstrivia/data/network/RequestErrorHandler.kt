...
/**
 * https://github.com/khaledymoh/Covid-19/blob/master/data/src/main/java/io/covid19/data/network/RequestErrorHandler.kt
 */
object RequestErrorHandler {
    ...
    fun getRequestError(throwable: Throwable): DataSourceException {
        return when (throwable) {
            ...
            is IOException -> {
                DataSourceException.Connection(R.string.CommonErrorNetwork)
            }
