# EndlessTrivia
A sample kotlin android app that showcase how to build an MVVM application using some of the jetpack libraries with Kotlin Coroutines & Dagger2.
This App is using [the open db API](https://opentdb.com/api_config.php) as a remote data source
